...
def test_url_scope_requires_path_relation_not_only_same_host():
    related = classify_suppressed_row(_row(
        "url", "https://example.com/torvalds",
        title="Archived page",
        url="https://example.com/torvalds/linux",
    ))
    assert related.tier == "possible"

    unrelated_same_host = classify_suppressed_row(_row(
        "url", "https://example.com/torvalds",
        title="Archived page",
        url="https://example.com/other/path",
    ))
    assert unrelated_same_host.tier == "suppressed"
