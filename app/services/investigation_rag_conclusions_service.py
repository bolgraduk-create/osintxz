    ...
    def _build_workflow_context(
        ...
        *,
        ...
        return (
            ...
            "evidence confidence.\n"
            "- When evidence_confidence is present, it is canonical "
            "M024 proposition-support confidence, not a general truth "
            "score for the whole source.\n"
            "- evidence_confidence_coverage describes assessment "
            "coverage; low coverage must remain explicit uncertainty.\n"
            "- Never invent or extrapolate confidence values that are "
            "not supplied by the Evidence layer.\n"
            "- evidence_reason and evidence_limitation are deterministic "
            "M025 explanations. They may be paraphrased, but their causal "
            "meaning must not be extended beyond the supplied explanation.\n"
            "- investigation_explanation / investigation_reason use the "
            "unified M025b WHY contract. Search explanations describe why an "
            "item was found or ranked, not whether its content is true.\n"
