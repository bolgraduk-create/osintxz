        ...
        if not self.prompt_manager.has_prompt(
            ...
            self.prompt_manager.register_prompt(
                ...
                template=(
                    ...
                    "- evidence_reason and evidence_limitation lines are "
                    "deterministic M025 explanations from the Evidence layer. "
                    "You may paraphrase them, but do not invent additional "
                    "causes for a confidence score.\n"
                    "- investigation_explanation / investigation_reason lines "
                    "use the unified M025b WHY contract. Search WHY_FOUND and "
                    "WHY_RANKED explain retrieval/ranking only; they do not "
                    "prove the underlying claim true.\n"
