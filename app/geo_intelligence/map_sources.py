...
BUILTIN_MAP_SOURCES: tuple[MapSourceDescriptor, ...] = (
    ...
    MapSourceDescriptor(
        ...
        terms_url="https://opentopomap.org/about",
        min_zoom=0,
        max_zoom=17,
        metadata={
            ...
            "description": "Topographic map with contours, terrain and outdoor context.",
            "policyNote": "Attribution required; contact provider for larger projects.",
            "cachePolicy": "http_headers",
            "prefetchAllowed": False,
        },
    ),
    MapSourceDescriptor(
        ...
        min_zoom=0,
        max_zoom=18,
        wms_layers="BlueMarble_ShadedRelief",
        wms_styles="",
        ...
        metadata={
            ...
            "role": "base",
            "primarySelectable": True,
            "description": "Global shaded-relief Earth imagery for broad geographic context.",
            "policyNote": "Official NASA GIBS WMS layer.",
            "cachePolicy": "http_headers",
            "prefetchAllowed": False,
        },
    ),
    MapSourceDescriptor(
        id="nasa_aster_elevation",
        name="NASA ASTER Elevation",
        kind="wms",
        category="topographic",
        url="https://gibs.earthdata.nasa.gov/wms/epsg3857/best/wms.cgi",
        attribution="NASA EOSDIS GIBS",
        ...
        min_zoom=0,
        max_zoom=18,
        wms_layers="ASTER_GDEM_Color_Index",
        wms_styles="",
        ...
        metadata={
            ...
            "role": "base",
            "primarySelectable": True,
            "description": "Global elevation color index useful for terrain and relief analysis.",
            "policyNote": "Official NASA GIBS layer.",
            "cachePolicy": "http_headers",
            "prefetchAllowed": False,
        },
    ),
    MapSourceDescriptor(
        id="nasa_viirs_city_lights",
        ...
        min_zoom=0,
        max_zoom=18,
        wms_layers="VIIRS_CityLights_2012",
        wms_styles="",
        wms_format="image/png",
        wms_version="1.1.1",
        wms_transparent=False,
        metadata={
            ...
            "role": "base",
            "primarySelectable": True,
            "description": "Night-time lights layer useful for settlement and urbanization context.",
            "policyNote": "Official NASA GIBS layer.",
            "cachePolicy": "http_headers",
            "prefetchAllowed": False,
        },
    ...
    MapSourceDescriptor(
        ...
        metadata={
            ...
            "overlayPreferred": True,
            "description": "Transparent maritime seamarks and navigation overlay.",
            "policyNote": "Use as an overlay above a base map.",
            "cachePolicy": "http_headers",
            "prefetchAllowed": False,
        },
    ),
    MapSourceDescriptor(
        id="openrailwaymap_reference",
        name="OpenRailwayMap · reference",
        kind="xyz",
        ...
        metadata={
            ...
            "description": "Railway infrastructure overlay: tracks, stations and line context.",
            "policyNote": "Public tiles restrict non-public/commercial use; use only under their policy or self-host.",
            "cachePolicy": "http_headers",
            "prefetchAllowed": False,
        },
    ),
