...
BUILTIN_MAP_SOURCES: tuple[MapSourceDescriptor, ...] = (
    ...
    MapSourceDescriptor(
        id="fr_ign_ortho_1950_1965",
        name="France · Historical Orthophotos 1950–1965",
        kind="xyz",
        category="historical",
        region="France",
        provider="IGN France / Géoplateforme",
        tags=("france", "historical", "orthophoto", "aerial", "1950", "1965"),
        url="https://data.geopf.fr/wmts?SERVICE=WMTS&REQUEST=GetTile&VERSION=1.0.0&LAYER=ORTHOIMAGERY.ORTHOPHOTOS.1950-1965&STYLE=normal&FORMAT=image/png&TILEMATRIXSET=PM&TILEMATRIX={z}&TILEROW={y}&TILECOL={x}",
        attribution="© IGN France",
        terms_url="https://cartes.gouv.fr/",
        min_zoom=0,
        max_zoom=18,
        metadata={
            "cachePolicy": "http_headers",
    ...
    MapSourceDescriptor(
        id="fr_ign_scan50_1950",
        name="France · SCAN 50 Historical 1950",
        kind="xyz",
        category="historical",
        region="France",
        provider="IGN France / Géoplateforme",
        tags=("france", "historical", "scan50", "1950", "topographic"),
        url="https://data.geopf.fr/wmts?SERVICE=WMTS&REQUEST=GetTile&VERSION=1.0.0&LAYER=GEOGRAPHICALGRIDSYSTEMS.MAPS.SCAN50.1950&STYLE=normal&FORMAT=image/png&TILEMATRIXSET=PM&TILEMATRIX={z}&TILEROW={y}&TILECOL={x}",
        attribution="© IGN France",
        terms_url="https://cartes.gouv.fr/",
        min_zoom=3,
        max_zoom=18,
    ...
    MapSourceDescriptor(
        id="fr_bnf_cassini",
        name="France · Cassini Map",
        kind="xyz",
        category="historical",
        region="France",
        provider="Bibliothèque nationale de France / IGN",
        tags=("france", "historical", "cassini", "18th century", "bnf"),
        url="https://data.geopf.fr/wmts?SERVICE=WMTS&REQUEST=GetTile&VERSION=1.0.0&LAYER=BNF-IGNF_GEOGRAPHICALGRIDSYSTEMS.CASSINI&STYLE=normal&FORMAT=image/png&TILEMATRIXSET=PM&TILEMATRIX={z}&TILEROW={y}&TILECOL={x}",
        attribution="© BnF · IGN France",
        terms_url="https://cartes.gouv.fr/",
        min_zoom=3,
        max_zoom=18,
        metadata={
    ...
    MapSourceDescriptor(
        id="fr_ign_etat_major_40",
        name="France · État-major 1820–1866",
        kind="xyz",
        category="historical",
        region="France",
        provider="IGN France / Géoplateforme",
        tags=("france", "historical", "etat-major", "19th century", "1820", "1866"),
        url="https://data.geopf.fr/wmts?SERVICE=WMTS&REQUEST=GetTile&VERSION=1.0.0&LAYER=GEOGRAPHICALGRIDSYSTEMS.ETATMAJOR40&STYLE=normal&FORMAT=image/jpeg&TILEMATRIXSET=PM&TILEMATRIX={z}&TILEROW={y}&TILECOL={x}",
        attribution="© IGN France",
        terms_url="https://cartes.gouv.fr/",
        min_zoom=3,
        max_zoom=18,
