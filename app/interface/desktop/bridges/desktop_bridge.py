...
from app.interface.desktop.analysis_workspace_payloads import (
    build_map_workspace_payload,
    build_media_workspace_payload,
)
...
class DesktopBridge(QObject):
    ...
    def analysisMediaWorkspace(self) -> dict[str, Any]:
        return build_media_workspace_payload(
            self._container,
    ...
    def analysisMapWorkspace(self) -> dict[str, Any]:
        return build_map_workspace_payload(
            self._container,
            case_id=self._current_case_id,
            case_title=self.currentCaseTitle,
        )
