    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            StatCard {
                ...
                value: String(Number(root.summary.identityStrong || 0) + Number(root.summary.identitySupported || 0))
                delta: ""
                subtext: String(root.summary.identityPossible || 0) + " possible · " + String(root.summary.identityConflicting || 0) + " conflicting"
                    ...
                    Rectangle {
                        ...
                        Text {
                            ...
                            text: desktopBridge.hasCurrentCase
                                ? ("Case: " + desktopBridge.currentCaseTitle + " · Identity alignment is an explainable relevance score, not proof that records belong to the same person. Name-only matches cannot auto-pivot. Raw secret values are never stored.")
                                : "Select an investigation before running."
                            color: Theme.textMuted
                            font.pixelSize: 9
                        }
