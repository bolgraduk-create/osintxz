    ...
    try:
        ...
        checks = [
            (
                ...
                "M021.16.7.7.3unifiedspecialized+Open-Webflow"
                in compact,
            ),
            (
                "worker calls existing specialized OSINT",
                (
            ...
            (
                "payload contains OSINT result",
                '"osint":osint_result' in compact,
            ),
            (
                "payload contains Open-Web result",
        ...
        print("=" * 84)
        print("M021.16.7.7.3 EXACT WORKER INTEGRATION AUDIT")
        print("=" * 84)
